...
const ChatSidebar: React.FC<ChatSidebarProps> = ({ children, className = '' }) => (
  <aside className={`w-96 h-full flex flex-col z-20 ${className}`}>
    <div className="bg-white/60 backdrop-blur-md rounded-2xl border border-[#678969] shadow-xl p-4 flex flex-col justify-between h-full">
